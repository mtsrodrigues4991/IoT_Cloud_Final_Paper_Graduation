# Cloud Engineer Mateus Rodrigues 
#  10/23/2021
#  Code for azure IoT Enviroment -- Final Paper Graduation
######################################################################################################################################################
...
resource "azurerm_iothub" "iothubsigfox" {                              #cria e define um IoTHub
  name                = "iot-hub-sigfox-az-1"
  resource_group_name = azurerm_resource_group.rg.name
  location            = azurerm_resource_group.rg.location
